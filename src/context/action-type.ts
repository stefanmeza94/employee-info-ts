export enum ActionType {
  ...
  GET_ALL_TECHNOLOGIES_BEGIN = 'GET_ALL_TECHNOLOGIES_BEGIN',
  GET_ALL_TECHNOLOGIES_SUCCESS = 'GET_ALL_TECHNOLOGIES_SUCCESS',
  GET_ALL_TECHNOLOGIES_ERROR = 'GET_ALL_TECHNOLOGIES_ERROR',
  DELETE_TECHNOLOGY_BEGIN = 'DELETE_TECHNOLOGY_BEGIN',
  DELETE_TECHNOLOGY_SUCCESS = 'DELETE_TECHNOLOGY_SUCCESS',
  DELETE_TECHNOLOGY_ERROR = 'DELETE_TECHNOLOGY_ERROR',
  SET_EDIT_TECHNOLOGY = 'SET_EDIT_TECHNOLOGY',
  EDIT_TECHNOLOGY_BEGIN = 'EDIT_TECHNOLOGY_BEGIN',
  EDIT_TECHNOLOGY_SUCCESS = 'EDIT_TECHNOLOGY_SUCCESS',
  EDIT_TECHNOLOGY_ERROR = 'EDIT_TECHNOLOGY_ERROR',
}
